...
// --- 1. IMPORTAMOS AMBAS FUNCIONES DESDE NATIVEBRIDGE ---
import { GameDetectorPlugin, updateNativeUIColors } from './nativeBridge.js';
...
export function initThemesPage() {
    ...
    if (!themeSelector || !modeToggleButton) return;
    ...
    function renderThemeCircles() {
        ...
        for (const themeName in themes) {
            ...
            circleWrapper.addEventListener('click', () => {
                ...
                renderThemeCircles();
                 // --- 2. LLAMAMOS A AMBAS FUNCIONES DE SINCRONIZACIÓN ---
                syncThemeWithNative();
                updateNativeUIColors(); // <-- ESTA ERA LA LLAMADA QUE FALTABA
            });
    ...
    modeToggleButton.addEventListener('click', () => {
        ...
        // --- 3. TAMBIÉN LLAMAMOS A AMBAS AQUÍ ---
        syncThemeWithNative();
        updateNativeUIColors(); // <-- Y AQUÍ
    });
